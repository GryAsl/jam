...
public class MeshDestroy : MonoBehaviour
{
    ...
    public void DestroyMesh()
    {
        ...
        for (var c = 0; c < CutCascades; c++)
        {
            for (var i = 0; i < parts.Count; i++)
            {
                ...
                var plane = new Plane(UnityEngine.Random.onUnitSphere, new Vector3(UnityEngine.Random.Range(.1f, bounds.max.x),
                                                                                   UnityEngine.Random.Range(.1f, bounds.max.y),
                                                                                   UnityEngine.Random.Range(.1f, bounds.max.z)));
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            GameObject.AddComponent<MeshDestroyAfter>();
        }
